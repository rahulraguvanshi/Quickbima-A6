...
export declare class NgSelectComponent implements OnDestroy, OnChanges, AfterViewInit, ControlValueAccessor {
    ...
    constructor(config: NgSelectConfig, classes: string, _cd: ChangeDetectorRef, _console: ConsoleService, elementRef: ElementRef);
    ...
    _handleKeyPresses(): void;
    private _updateNgModel();
    private _clearSearch();
    private _scrollToMarked();
    private _scrollToTag();
    private _handleTab($event);
