...
var ItemsList = /** @class */ (function () {
    ...
    ItemsList.prototype.findItem = function (value) {
        ...
        if (this._ngSelect.compareWith) {
            ...
            findBy = function (item) { return !item.hasChildren && _this.resolveNested(item.value, _this._ngSelect.bindValue) === value; };
        }
        else {
            findBy = function (item) { return item.value === value ||
                !item.hasChildren && item.label && item.label === _this.resolveNested(value, _this._ngSelect.bindLabel); };
        }
